...
:main
:: Duplicate Ultimate Performance power scheme, customize it and make it the Alatas power scheme
powercfg /l | find "Power Scheme GUID: 11111111-1111-1111-1111-111111111111  (Alatas Power Scheme)" > nul || (
...
:: Set current power scheme to Alatas
powercfg /changename scheme_current "Alatas Power Scheme" "Power scheme optimized for optimal latency and performance."
...
call %windir%\AlatasModules\Scripts\toggleDev.cmd @("ACPI Processor Aggregator", "Microsoft Windows Management Interface for ACPI") > nul

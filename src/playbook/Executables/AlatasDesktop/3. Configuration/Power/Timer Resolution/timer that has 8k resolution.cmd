...
echo Before running this, please see the Alatas documentation, linked in the folder.
echo]
pause & cls
...
schtasks /create /tn "Force Timer Resolution" /xml "%windir%\AlatasModules\Other\Force Timer Resolution.xml" /f > nul

...
reg add "HKCR\DesktopBackground\shell\NVIDIAContainer\shell\NVIDIAContainer001\command" /ve /t REG_SZ /d "\"%windir%\AlatasDesktop\3. Configuration\NVIDIA Display Container\Enable NVIDIA Display Container LS.cmd"" /f > nul
...
reg add "HKCR\DesktopBackground\shell\NVIDIAContainer\shell\NVIDIAContainer002\command" /ve /t REG_SZ /d "\"%windir%\AlatasDesktop\3. Configuration\NVIDIA Display Container\Disable NVIDIA Display Container LS.cmd"" /f > nul

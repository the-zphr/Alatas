...
:ALLUSERS
if defined win11 reg add "HKU\%~1\SOFTWARE\Microsoft\Windows\CurrentVersion\Themes" /v "ThemeMRU" /t REG_SZ /d "%windir%\Resources\Themes\alatas-dark.theme;%windir%\resources\Themes\alatas-light.theme;%windir%\resources\Themes\alatas-legacy.theme;" /f > nul

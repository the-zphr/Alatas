...
if defined win10 (
    ...
    rem Set dual boot menu description to AlatasOS 10
    bcdedit /set description "AlatasOS 10" > nul

    rem Delete 11-only tweaks
    rd /s /q "%windir%\AlatasDesktop\3. Configuration\Background Apps" > nul 2>&1
    rd /s /q "%windir%\AlatasDesktop\3. Configuration\Power\Timer Resolution" > nul 2>&1
    rd /s /q "%windir%\AlatasDesktop\4. Optional Tweaks\File Explorer Customization\Compact View" > nul 2>&1
    rd /s /q "%windir%\AlatasDesktop\4. Optional Tweaks\File Explorer Customization\Gallery" > nul 2>&1
    rd /s /q "%windir%\AlatasDesktop\4. Optional Tweaks\Windows 11 Context Menu" > nul 2>&1
    del /f /q "%windir%\AlatasModules\Tools\TimerResolution.exe" > nul 2>&1
...
rd /s /q "%windir%\AlatasDesktop\3. Configuration\4. Optional Tweaks\Volume Flyout" > nul 2>&1
...
:: Set dual boot menu description to AlatasOS 11
bcdedit /set description "AlatasOS 11" > nul
